...
E = (QRG_CONTROL,)
CHEM = frozenset({"PVMRM", "OLM", "ARM2", "GRSM"})
...
MODEL_OPTIONS: tuple[ModelOptionSpec, ...] = (
    ...
    option(
        "ALPHA",
        OptionTier.CONTROL_FLAG,
        20,
        allowed_with_dfault=False,
    ...
    option(
        "GRSM",
        OptionTier.REGULATORY,
        210,
        allowed_with_dfault=None,
